...
That's it! I've got an old iMac running a modern 64-bit Xubuntu, where I can install software such as VSCode, Zoom, Chrome, etc. For Chrome to work properly, I had to disable `Use hardware acceleration when available`, since this was buggy with the old graphics card.
